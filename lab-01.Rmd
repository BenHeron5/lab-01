...
visitors %>% count(admission, region)
```
...
Not Available - some of the values given for n_2021 are not integers and therefore cannot be used in calculations
...
Its advises the computer to ignore all entries where there is no valid data for the specified variable
...
This suggests that the data consists of some large events which bring the average up significantly, but is primarily composed of smaller events than these. 
